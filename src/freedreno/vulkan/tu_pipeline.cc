                                    ...
                                    struct tu_pipeline *pipeline)
{
   ...
   const bool is_a830 = chip_id == 0x44050000ull || chip_id == 0x44050001ull;
   const bool disable_fdm_msaa = is_a810 || is_a825 || is_a829 || is_a830;
   /* === КОНЕЦ ДОБАВЛЕНИЯ === */
   ...
   if (builder->state &
      ...
      /* === ИЗМЕНЕНО: Отключаем FDM per layer на A810/A825/A829/A830 === */
   ...
   if (builder->state & VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT) {
       ...
       */
      /* === ИЗМЕНЕНО: Отключаем force_sample_interp на A810/A825/A829/A830 === */
