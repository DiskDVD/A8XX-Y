                                    ...
                                    struct tu_pipeline *pipeline)
{
   ...
   const bool is_a810 = chip_id == 0x44010000ull || chip_id == 0xffff44010000ull;
   const bool is_a812 = chip_id == 0x44010200ull || chip_id == 0xffff44010200ull;
   const bool is_a825 = chip_id == 0x44030000ull || chip_id == 0xffff44030000ull;
   const bool is_a829 = chip_id == 0x44030A20ull || chip_id == 0xffff44030A20ull;
   const bool is_a830 = chip_id == 0x44050001ull || chip_id == 0xffff44050001ull;
