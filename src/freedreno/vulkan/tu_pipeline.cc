                                    ...
                                    struct tu_pipeline *pipeline)
{
   ...
   const bool is_a8xx_perf_sensitive = is_a810 || is_a825 || is_a829 || is_a830;
   ...
   if (builder->state &
      ...
      const bool enable_fdm_per_layer =
         is_a8xx_perf_sensitive ?
         (builder->fdm_per_layer && builder->fragment_density_map) :
         builder->fdm_per_layer;
      keys[last_pre_rast_stage].fdm_per_layer = enable_fdm_per_layer;
   }
   ...
   if (builder->state & VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT) {
      ...
      const bool enable_fdm_per_layer =
         ...
         (builder->fdm_per_layer && builder->fragment_density_map) :
         builder->fdm_per_layer;
      keys[MESA_SHADER_FRAGMENT].fdm_per_layer = enable_fdm_per_layer;
